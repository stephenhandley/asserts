...
function Test (tests) {
  ...
  // in the case, the result will get treated as group to be processed and run as in previous case
...
Test.prototype.runNextAtomInGroup = function () {
  ...
  // memoized array of group's tests
  if (!this.group_tests) {
...
Test.prototype.display = function (num_spaces) {
  ...
  if (this.isGroup()) {
    Object.keys(this.group).forEach(function (label) {
